  ...
  <div class="content_area">
    ...
    <el-form ref="formRef" :model="formData" label-width="80px" :rules="formRules">
      ...
      <el-form-item label="关键字" prop="keywords">
        <el-input v-model="formData.keywords" :formatter="(value) => value.replace(' ', ',')"
          :parser="(value) => value.replace(' ', ',')" placeholder="输入一个关键字后，按空格自动分隔"></el-input>
      </el-form-item>
      ...
      <el-form-item label="简介" prop="description">
        <el-input class="desc" v-model="formData.description" type="textarea" placeholder="请输入文章简介"></el-input>
      </el-form-item>
...
const saveForm = () => {
  ...
  formRef.value.validate((valid) => {
    if (!valid) return
    addNews(formData.value).then((result:any) => {
      console.log(result);
