...
public interface UserMapper {
    @Select("select * from t_user where role != '3'")
    List<User> selectAll();
    @Select("select * from t_user where role != '3'")
    ...
    @Update("update t_user set nickname=#{nickname},tel=#{tel},email=#{email},sex=#{sex},imageUrl=#{imageUrl} where id=#{id}")
    ...
    @Select("<script>" +
            ...
            "</if>" +
            "</script>")
    List<User> searchUsersByCompany(@Param("name") String name,
                                   @Param("nickname") String nickname,
                                   @Param("tel") String tel,
                                   @Param("startDate") String startDate,
                                   @Param("endDate") String endDate,
